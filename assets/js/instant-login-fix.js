// NATYCHMIASTOWA NAPRAWA LOGOWANIA - JAVASCRIPT v4.0
console.log('🚀 Ładowanie ulepszonego logowania v4.0 z dynamicznymi URL - ' + new Date().toLocaleTimeString() + '...');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (wooContainer || accountContainer) {
                            ...
                            ">
                                ...
                                <span class="button-spinner" style="display: none;">
                                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" style="animation: spin 1s linear infinite;">
                                        <circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4" stroke-dasharray="60" stroke-dashoffset="30" opacity="0.3"/>
                                    </svg>
                                </span>
                ...
                ">
                    ...
                    <div class="enhanced-login-form" style="padding: 25px;">
                        <form method="post" id="custom-lost-password-form" style="margin-top: 15px;">
                            ...
                            <button type="submit" name="wc_reset_password" value="Zresetuj hasło" style="
                                background: linear-gradient(135deg, #1E3A8A, #2563eb);
                                color: white;
                                border: none;
                                padding: 14px 24px;
                        ...
                        <div style="text-align: center; margin-top: 15px; padding-top: 15px; border-top: 1px solid rgba(226, 232, 240, 0.5);">
                            <p style="
                                ...
                                margin: 0;
                            ">
                                Pamiętasz hasło? <a href="/wordpress/moje-konto/" style="color: #1E3A8A; text-decoration: none; font-weight: 600;">Zaloguj się</a>
                            </p>
                        </div>
                    </div>
                </div>
        ...
        // Pobierz nonce dla WooCommerce - już nie potrzebujemy, używamy AJAX
        console.log('✅ Formularz gotowy do obsługi AJAX');
        
        // Dodaj obsługę formularzy AJAX
        setupAjaxForms();
...
window.showLoginForm = function() {
    location.reload(); // Najprościej przeładuj stronę bez parametrów
};
...
function handleLoginSubmit(e) {
    ...
    .then(data => {
        if (data.success) {
            ...
            resetButton(submitButton, buttonText, buttonSpinner, buttonIcon);
        }
    })
    .catch(error => {
...
function resetButton(button, textElement, spinner, icon) {
    textElement.textContent = textElement.textContent.includes('Logowanie') ? 'Zaloguj się' : 
                             textElement.textContent.includes('Rejestracja') ? 'Zarejestruj się' : 
                             'Wyślij link';
